...
const TaskCard = ({ icon, title, description, categoryIcon, categoryName }) => {
  return (
    <section className="task-card">
      ...
      <div className="task-actions">
        <button className="task-btn-primary">השלמתי</button>
        <button className="task-btn-secondary">אין לי כוח</button>
      </div>
