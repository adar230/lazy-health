...
const FallbackTaskCard = ({ icon, label, description, buttonText, onComplete, isCompleting }) => {
  return (
    <section className="fallback-card">
      ...
      <button className="fallback-btn" onClick={onComplete} disabled={isCompleting}>
        {isCompleting ? 'בוצע ✓' : buttonText}
      </button>
    </section>
  );
};
